...
class UserRequestExtension extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('get_show_path', [UserRequestExtensionRuntime::class, 'getShowPath']),
            ...
            new TwigFunction('get_take_over_path', [UserRequestExtensionRuntime::class, 'getTakeOverPath']),
        ];
    }
}
