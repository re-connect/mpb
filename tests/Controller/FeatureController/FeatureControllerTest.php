...
class FeatureControllerTest extends AbstractControllerTest implements TestRouteInterface
{
    private const VOTE_URL = '/features/%s/vote';
    private const MARK_DONE_URL = '/features/%s/mark-done';
    ...
    public function provideTestRoute(): \Generator
    {
        ...
        yield '[MarkDone] Should redirect to list when connected as user' => [self::MARK_DONE_URL, 302, UserFixtures::USER_MAIL, self::LIST_URL];
        yield '[MarkDone] Should redirect to list when connected as team member' => [self::MARK_DONE_URL, 302, UserFixtures::TEAM_USER_MAIL, self::LIST_URL];
